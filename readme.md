...
| **DJANGO_ALLOWED_HOSTS** | Список разрешённых хостов через запятую, например `localhost,127.0.0.1`. При деплое укажите домен/IP сервера. |
